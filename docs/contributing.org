...
- add icons
- edit YOUR in tauri.conf.json and Entitlements.plist
...
xcrun altool --upload-app --type ios --file "src-tauri/gen/apple/build/arm64/tauri-solidjs-fs-template.ipa" --apiKey "" --apiIssuer ""
